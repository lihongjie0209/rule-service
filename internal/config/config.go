...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "rule-service")
	...
	v.SetDefault("database.schema", "rule_service")
	...
	v.SetDefault("jwt.issuer", "rule-service")
	...
	v.SetDefault("auth.audience", "rule-service")
	...
	v.SetDefault("migration.table", "rule_service_schema_migrations")
...
func (c Config) Validate() error {
	...
	if c.App.Env == "production" && (c.Auth.JWKSURL == "" || c.Auth.Issuer == "" || c.Auth.Audience != "rule-service") {
		return errors.New("production authentication requires identity JWKS URL, issuer, and rule-service audience")
	}
